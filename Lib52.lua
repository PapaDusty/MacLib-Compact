...
function MacLib:Window(Settings)
    ...
    globalSettingsButton.Parent = leftTopbarGroup
    ...
    exit.Parent = rightTopbarGroup
    minimize.Parent = rightTopbarGroup
    maximize.Parent = rightTopbarGroup
    ...
    sidebar.Position = UDim2.new(0, 0, 0, 50)  -- Adjusted for new topbar height
    ...
    -- Fixed UserInfo positioning: anchored to bottom, inside sidebar
    ...
    divider5.Position = UDim2.new(0, 6, 1, -85)
    ...
    content.Position = UDim2.new(0.245, 0, 0, 50)  -- Adjusted for new topbar height
    content.Size = UDim2.new(0.755, 0, 1, -50)
    ...
    UserInputService.InputChanged:Connect(function(input)
        if resizingContent and input.UserInputType == Enum.UserInputType.MouseMovement then
            ...
            content.Position = UDim2.new(0, newSidebarWidth, 0, 50)
            content.Size = UDim2.new(0, base.AbsoluteSize.X - newSidebarWidth, 1, -50)
        end
    end)
    ...
    function WindowFunctions:TabGroup()
        ...
        function SectionFunctions:Tab(Settings)
            ...
            function TabFunctions:Section(Settings)
                ...
                local function applyHoverEffect(frame, hoverCallback, leaveCallback)
                    local function onHover()
                        if hoverCallback then hoverCallback() end
                        Tween(frame, TweenInfo.new(0.2, Enum.EasingStyle.Sine), {
                ...
                function SectionFunctions:Button(Settings, Flag)
                    ...
                    -- Hover effect for button frame
                    applyHoverEffect(button, nil, nil)
                ...
                function SectionFunctions:Toggle(Settings, Flag)
                    ...
                    -- Hover effect with toggle color
                    local hoverTween
                    local function onToggleHover()
                        if togglebool then
                            hoverTween = Tween(toggle1, TweenInfo.new(0.2, Enum.EasingStyle.Sine), { ImageColor3 = Color3.fromRGB(100, 100, 100) })
                        else
                            hoverTween = Tween(toggle1, TweenInfo.new(0.2, Enum.EasingStyle.Sine), { ImageColor3 = Color3.fromRGB(120, 120, 120) })
                        end
                        hoverTween:Play()
                    end
                    local function onToggleLeave()
                        hoverTween = Tween(toggle1, TweenInfo.new(0.2, Enum.EasingStyle.Sine), { ImageColor3 = Color3.fromRGB(87, 86, 86) })
                        hoverTween:Play()
                    end
                    toggle1.MouseEnter:Connect(onToggleHover)
                    toggle1.MouseLeave:Connect(onToggleLeave)
                    applyHoverEffect(toggle, nil, nil)
                ...
                function SectionFunctions:Slider(Settings, Flag)
                    ...
                    -- New simple formatting with Prefix and Suffix
                    local prefix = Settings.Prefix or ""
                    local suffix = Settings.Suffix or ""
                    local function FormatValue(value)
                        local formatted = value
                        if Settings.Precision then
                            formatted = string.format("%." .. Settings.Precision .. "f", value)
                        else
                            formatted = tostring(math.floor(value * 100) / 100)  -- default 2 decimals
                        end
                    ...
                    local function SetValue(val, ignorecallback)
                        ...
                        local displayText = FormatValue(finalValue)
                    ...
                    if showValueBox and sliderValue then
                        sliderValue.FocusLost:Connect(function(enterPressed)
                            ...
                            local cleaned = inputText:gsub("^" .. prefix, ""):gsub(suffix .. "$", "")
                            ...
                            if value then
                                ...
                                sliderValue.Text = FormatValue(finalValue)
                            end
                    ...
                    local function updateSliderBarSize()
                        ...
                        local sliderValueWidth = 0
                        if showValueBox and sliderValue then
                            sliderValueWidth = sliderValue.AbsoluteSize.X
                        end
                    ...
                    -- Hover effect
                    applyHoverEffect(slider, nil, nil)
                ...
                function SectionFunctions:Input(Settings, Flag)
                    ...
                    -- Hover effect
                    applyHoverEffect(input, nil, nil)
                ...
                function SectionFunctions:Keybind(Settings, Flag)
                    ...
                    -- Hover effect
                    applyHoverEffect(keybind, nil, nil)
                ...
                function SectionFunctions:Dropdown(Settings, Flag)
                    ...
                    -- Search box (works for both single and multi)
                    ...
                    search.Visible = DropdownFunctions.Settings.Search or false
                    ...
                    local function findOption()
                        ...
                        for _, v in pairs(OptionObjs) do
                            ...
                            local isVisible = searchTerm == "" or string.find(optionText, searchTerm) ~= nil
                        ...
                        if DropdownFunctions.Settings.Default then
                            if DropdownFunctions.Settings.Multi then
                                if type(DropdownFunctions.Settings.Default) == "table" then
                                    isSelected = table.find(DropdownFunctions.Settings.Default, v) ~= nil
                                end
                            else
                                if type(DropdownFunctions.Settings.Default) == "number" then
                                    isSelected = (DropdownFunctions.Settings.Default == i)
                                elseif type(DropdownFunctions.Settings.Default) == "string" then
                                    isSelected = (DropdownFunctions.Settings.Default == v)
                                end
                            end
                        end
                        Toggle(v, isSelected)
                    ...
                    -- Hover effect
                    applyHoverEffect(dropdown, nil, nil)
                ...
                function SectionFunctions:Colorpicker(Settings, Flag)
                    ...
                    -- Hover effect for colorpicker
                    applyHoverEffect(colorpicker, nil, nil)
                ...
                function SectionFunctions:Label(Settings, Flag)
                    ...
                    -- Hover effect
                    applyHoverEffect(label, nil, nil)
                ...
                function SectionFunctions:SubLabel(Settings, Flag)
                    ...
                    -- Hover effect
                    applyHoverEffect(subLabel, nil, nil)
                ...
                function SectionFunctions:Paragraph(Settings, Flag)
                    ...
                    -- Hover effect
                    applyHoverEffect(paragraph, nil, nil)
            ...
            function TabFunctions:InsertWindowsSection(Side)
                local windowsSection = self:Section({ Side = Side or "Left" })

                windowsSection:Button({
                    Name = "Unload GUI",
                    Callback = function()
                ...
                local keybindElement = windowsSection:Keybind({
                    Name = "Menu Keybind",
                ...
                local scaleSlider = windowsSection:Slider({
                    Name = "UI Scale",
    ...
    function WindowFunctions:Notify(Settings)
        ...
        notificationUIStroke.Transparency = 0.95   -- Fixed to 0.95
...
function MacLib:Demo()
    ...
    tabs.Windows:InsertWindowsSection("Left")
