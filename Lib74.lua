...
function MacLib:Window(Settings)
    ...
    sidebarDivider.Size = UDim2.fromOffset(1, 487)
    ...
    sidebarGroupUIPadding.PaddingBottom = UDim.new(0, 25)
    ...
    userAndDisplayFrame.AutomaticSize = Enum.AutomaticSize.X
    userAndDisplayFrame.Size = UDim2.fromOffset(0, 22)
    ...
    globalSettings.Position = UDim2.fromScale(0.85, 0.104)
    globalSettings.ZIndex = 999
        ...
        function SectionFunctions:Tab(Settings)
            ...
            function TabFunctions:Section(Settings)
                ...
                function SectionFunctions:Label(Settings, Flag)
                    ...
                    labelUIPadding.PaddingBottom = UDim.new(0, -5)
    ...
    function WindowFunctions:SetAcrylicBlurState(State)
        ...
        base.GlobalSettings.BackgroundTransparency = State and 0.05 or 0
    end
