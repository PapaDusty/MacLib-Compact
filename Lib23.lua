...
local assets = {
	...
	notificationIcon = "rbxassetid://3926305904",
...
function MacLib:Window(Settings)
	...
	function WindowFunctions:Notify(Settings)
		...
		notificationTitle.TextSize = 18  -- increased from 13
		...
		notificationTitleUIPadding.PaddingLeft = UDim.new(0, 28)  -- room for icon
		...
		notificationDescriptionUIPadding.PaddingLeft = UDim.new(0, 28)  -- align with title
		notificationDescriptionUIPadding.PaddingRight = UDim.new(0, 25)
		notificationDescriptionUIPadding.PaddingTop = UDim.new(0, 22)   -- adjusted for larger title
