...
function MacLib:Window(Settings)
    ...
    leftTopbarGroupUIListLayout.Padding = UDim.new(0, 12)  -- Added spacing between LogoFrame and TitleFrame
    ...
    logoImage.Size = UDim2.fromOffset(24, 24)  -- Smaller size
    logoImage.AnchorPoint = Vector2.new(0.5, 0.5)
    logoImage.Position = UDim2.fromScale(0.5, 0.5)
    logoImage.Image = Settings.Logo or "rbxassetid://117622109572070"  -- New default ID
    ...
    -- Fixed UserInfo positioning: now sits flush at the bottom without overflow
    ...
    userInfo.Position = UDim2.new(0, 0, 1, 0)  -- Removed negative X offset and positive Y offset
