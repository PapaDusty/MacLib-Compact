		...
		function SectionFunctions:Tab(Settings)
			...
			function TabFunctions:Section(Settings)
				...
				function SectionFunctions:Button(Settings, Flag)
				    ...
				    buttonPadding.Name = "SectionUIPadding"
				...
				function SectionFunctions:Slider(Settings, Flag)
					...
					--local sliderValue = nil          -- ADDED (will be either TextBox or TextLabel)
					--local floatingLabel = nil        -- ADDED
					...
					if showValueBox then
    					...
    					headValue.TextTransparency = 0.1
    					headValue.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
    					headValue.BackgroundTransparency = 0.3
...
=
    					...
    					headStroke.Transparency = 0.7
    					headStroke.Parent = headValue
    					local labelCorner = Instance.new("UICorner")
    					headCorner.CornerRadius = UDim.new(0, 4)
    					headCorner.Parent = headValue

    					headValue.Parent = sliderHead
    					headValue.Position = UDim2.new(0.5, 0, -0.5, -8)
					end
					...
					local function SetValue(val, ignorecallback)
    					...
    					if showValueBox then
        					...
        					if dragging then
            					headValue.Visible = true --visibility
        					else
            					headValue.Visible = true   -- false = value only shows while dragging
        					end
        					headValue.Position = UDim2.new(0.5, 0, -0.5, -8)
    					end
