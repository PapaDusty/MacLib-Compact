...
function MacLib:Window(Settings)
	...
	--// New: Left container for logo and title
	...
	leftContainer.Size = UDim2.new(1, -40, 1, 0) -- leave space for settings button
	leftContainer.Parent = informationHolder

	local leftContainerLayout = Instance.new("UIListLayout")
	leftContainerLayout.Name = "LeftContainerLayout"
	leftContainerLayout.FillDirection = Enum.FillDirection.Horizontal
	leftContainerLayout.Padding = UDim.new(0, 15)
	leftContainerLayout.SortOrder = Enum.SortOrder.LayoutOrder
	leftContainerLayout.VerticalAlignment = Enum.VerticalAlignment.Center
	leftContainerLayout.Parent = leftContainer
	...
	logoImage.Image = "rbxassetid://117622109572070"
	...
	--// Title Frame (same as before, now inside leftContainer)
	...
	titleFrame.Size = UDim2.new(1, -34 - 15, 1, 0) -- fill remaining width
	titleFrame.Parent = leftContainer
	...
	--// Global Settings Button (anchored right)
	...
	globalSettingsButton.Position = UDim2.new(1, -8, 0.5, 0)
	...
	-- Fix: Y offset changed from 20 to 0 to prevent sticking outside
	userInfo.Position = UDim2.new(0, -25, 1, 0)
	...
	currentTab.FontFace = Font.new(assets.interFont, Enum.FontWeight.Medium, Enum.FontStyle.Normal)
