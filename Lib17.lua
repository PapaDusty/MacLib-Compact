		...
		function SectionFunctions:Tab(Settings)
			...
			function TabFunctions:InsertConfigSection(Side)
				...
				configSection:Button({
    				...
    				Callback = function()
        				local selected = MacLib.Options["Select Config"] 
        				...
        				local configName = selected.Value
        				...
        				if isfile and isfile(filePath) then
            				...
            				local configDropdown = MacLib.Options["Select Config"]
            				if configDropdown and configDropdown.ClearOptions and configDropdown.InsertOptions then
