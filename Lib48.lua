...
function MacLib:Window(Settings)
    ...
    logoImage.Image = Settings.Logo or "rbxassetid://18821914323"
    ...
    userInfoFrame.Size = UDim2.new(0, 150, 1, 0)
    ...
    headshotUIStroke.Name = "UIStroke"
    ...
    headshot.Parent = userInfoFrame

    local userNamesFrame = Instance.new("Frame")
    userNamesFrame.Name = "UserNamesFrame"
    userNamesFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    userNamesFrame.BackgroundTransparency = 1
    userNamesFrame.Size = UDim2.new(1, 0, 1, 0)

    local userNamesLayout = Instance.new("UIListLayout")
    userNamesLayout.Name = "UserNamesLayout"
    userNamesLayout.Padding = UDim.new(0, 2)
    userNamesLayout.SortOrder = Enum.SortOrder.LayoutOrder
    userNamesLayout.VerticalAlignment = Enum.VerticalAlignment.Center
    userNamesLayout.Parent = userNamesFrame
    ...
    displayName.Parent = userNamesFrame
    ...
    username.Parent = userNamesFrame

    userNamesFrame.Parent = userInfoFrame

    userInfoFrame.Parent = leftTopbarGroup
