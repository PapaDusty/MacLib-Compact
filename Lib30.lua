...
function MacLib:Window(Settings)
	...
	--Themes
    function WindowFunctions:ThemesSection(Side)
        local themesTabGroup = WindowFunctions:TabGroup()
        local themesTab = themesTabGroup:Tab({ Name = "Themes" })
        local themesSection = themesTab:Section({ Side = Side or "Left" })
        ...
        themesSection:SubLabel({ Text = "Note: Changes only the main window background." })
    end
