...
local assets = {
	...
	notificationIcon = "rbxassetid://114019112889858",
...
function MacLib:Window(Settings)
		...
		function SectionFunctions:Tab(Settings)
			...
			function TabFunctions:Section(Settings)
				...
				function SectionFunctions:Button(Settings, Flag)
					...
					--buttonImage.Position = UDim.new(1, 0, 0.4, 5)
				...
				function SectionFunctions:Keybind(Settings, Flag)
					...
					--binderBox.Position = UDim2.fromScale(1, 0, 1, -18)
	...
	function WindowFunctions:Notify(Settings)
		...
		notification.Size = UDim2.fromOffset(Settings.SizeX or 280, 0)
		...
		-- Icon (16x16, top-aligned, small top margin)
		...
		notificationIcon.Size = UDim2.fromOffset(15, 15)
		notificationIcon.Parent = notificationInformation

		-- Title (top-aligned, starts after icon + gap)
		...
		notificationTitle.Position = UDim2.new(0, 32, 0, 10) -- 10 (icon left) + 16 (icon width) + 10 gap = 36
		notificationTitle.Parent = notificationInformation

		-- Description (left padding 5, top margin to clear icon+title row)
		...
		notificationDescriptionUIPadding.PaddingBotton = UDim.new(0, -7)
		...
		-- Overall padding for the notification content
		...
		--notificationUIPadding.PaddingLeft = UDim.new(0, 0)
		--notificationUIPadding.PaddingRight = UDim.new(0, 0)
		--notificationUIPadding.PaddingTop = UDim.new(0, 0)
		...
		-- Tweens and other logic (unchanged)
		local tweens = {
