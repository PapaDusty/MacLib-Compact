...
function MacLib:Window(Settings)
	...
	minimizeIcon.Image = "rbxassetid://122956405425921"
	minimizeIcon.ImageTransparency = 0.5
	minimizeIcon.AnchorPoint = Vector2.new(1, 0.5)      -- anchor to right
	minimizeIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	minimizeIcon.BackgroundTransparency = 1
	minimizeIcon.BorderColor3 = Color3.fromRGB(0, 0, 0)
	minimizeIcon.BorderSizePixel = 0
	minimizeIcon.Position = UDim2.new(1, -24, 0.5, 0)   -- 24px left of the right edge
	...
	minimizeIcon.MouseButton1Click:Connect(function()
    	...
    	--     Description = (base.Visible and "Maximized" or "Minimized") .. " the menu.",
    	--     Lifetime = 3
    	-- })
	end)
