...
local assets = {
    ...
    notificationIcon = "rbxassetid://129161768795909",
    colorWheel = "rbxassetid://129308714",
    ...
    minimizeIcon = "rbxassetid://131130048783546",
    exitIcon = "rbxassetid://94126783865996",
}
...
function MacLib:Window(Settings)
    ...
    topbarDivider.BorderColor3 = Color3.fromRGB(0, 0, 0)
    topbarDivider.BorderSizePixel = 0
    topbarDivider.Position = UDim2.fromScale(0, 1)
    topbarDivider.Size = UDim2.new(1, 0, 0, 1)
    topbarDivider.Parent = topbar

    local leftTopbarGroup = Instance.new("Frame")
    leftTopbarGroup.Name = "LeftTopbarGroup"
    leftTopbarGroup.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    leftTopbarGroup.BackgroundTransparency = 1
    leftTopbarGroup.BorderColor3 = Color3.fromRGB(0, 0, 0)
    leftTopbarGroup.BorderSizePixel = 0
    leftTopbarGroup.Size = UDim2.new(0.7, 0, 1, 0)

    local leftTopbarGroupUIListLayout = Instance.new("UIListLayout")
    leftTopbarGroupUIListLayout.Name = "LeftTopbarGroupUIListLayout"
    leftTopbarGroupUIListLayout.FillDirection = Enum.FillDirection.Horizontal
    leftTopbarGroupUIListLayout.SortOrder = Enum.SortOrder.LayoutOrder
    leftTopbarGroupUIListLayout.VerticalAlignment = Enum.VerticalAlignment.Center
    leftTopbarGroupUIListLayout.Padding = UDim.new(0, 12)
    leftTopbarGroupUIListLayout.Parent = leftTopbarGroup

    local leftTopbarGroupUIPadding = Instance.new("UIPadding")
    leftTopbarGroupUIPadding.Name = "LeftTopbarGroupUIPadding"
    leftTopbarGroupUIPadding.PaddingLeft = UDim.new(0, 8)  -- reduced from 15 to move logo closer
    leftTopbarGroupUIPadding.Parent = leftTopbarGroup

    local logoFrame = Instance.new("Frame")
    logoFrame.Name = "LogoFrame"
    logoFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    logoFrame.BackgroundTransparency = 0.98
    logoFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
    logoFrame.BorderSizePixel = 0
    logoFrame.Size = UDim2.fromOffset(32, 32)

    local logoFrameUICorner = Instance.new("UICorner")
    logoFrameUICorner.Name = "LogoFrameUICorner"
    logoFrameUICorner.CornerRadius = UDim.new(0, 8)
    logoFrameUICorner.Parent = logoFrame

    local logoFrameUIStroke = Instance.new("UIStroke")
    logoFrameUIStroke.Name = "LogoFrameUIStroke"
    logoFrameUIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    logoFrameUIStroke.Color = Color3.fromRGB(255, 255, 255)
    logoFrameUIStroke.Transparency = 0.9
    logoFrameUIStroke.Parent = logoFrame
    ...
    logoImage.Image = Settings.Logo or "rbxassetid://117622109572070"
    logoImage.ScaleType = Enum.ScaleType.Fit
    logoImage.Parent = logoFrame

    logoFrame.Parent = leftTopbarGroup
    ...
    titleFrame.Size = UDim2.new(0, 180, 1, 0)
    ...
    titleFrame.Parent = leftTopbarGroup

    leftTopbarGroup.Parent = topbar

    -- Right top bar group
    local rightTopbarGroup = Instance.new("Frame")
    rightTopbarGroup.Name = "RightTopbarGroup"
    rightTopbarGroup.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    rightTopbarGroup.BackgroundTransparency = 1
    rightTopbarGroup.BorderColor3 = Color3.fromRGB(0, 0, 0)
    rightTopbarGroup.BorderSizePixel = 0
    rightTopbarGroup.Size = UDim2.new(0.3, 0, 1, 0)
    rightTopbarGroup.Position = UDim2.new(0.7, 0, 0, 0)

    local rightTopbarGroupUIListLayout = Instance.new("UIListLayout")
    rightTopbarGroupUIListLayout.Name = "RightTopbarGroupUIListLayout"
    rightTopbarGroupUIListLayout.FillDirection = Enum.FillDirection.Horizontal
    rightTopbarGroupUIListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Right
    rightTopbarGroupUIListLayout.SortOrder = Enum.SortOrder.LayoutOrder
    rightTopbarGroupUIListLayout.VerticalAlignment = Enum.VerticalAlignment.Center
    rightTopbarGroupUIListLayout.Padding = UDim.new(0, 12)
    rightTopbarGroupUIListLayout.Parent = rightTopbarGroup

    local rightTopbarGroupUIPadding = Instance.new("UIPadding")
    rightTopbarGroupUIPadding.Name = "RightTopbarGroupUIPadding"
    rightTopbarGroupUIPadding.PaddingRight = UDim.new(0, 15)
    rightTopbarGroupUIPadding.Parent = rightTopbarGroup

    -- Helper to create topbar icon boxes (like LogoFrame)
    local function createTopBarIcon(imageId, hoverCallback)
        ...
        btn.MouseEnter:Connect(function()
            Tween(btn, TweenInfo.new(0.2, Enum.EasingStyle.Sine), {ImageTransparency = 0.2}):Play()
            Tween(stroke, TweenInfo.new(0.2, Enum.EasingStyle.Sine), {Transparency = 0.7}):Play()
        end)
        btn.MouseLeave:Connect(function()
            Tween(btn, TweenInfo.new(0.2, Enum.EasingStyle.Sine), {ImageTransparency = 0.5}):Play()
            Tween(stroke, TweenInfo.new(0.2, Enum.EasingStyle.Sine), {Transparency = 0.9}):Play()
        end)

        if hoverCallback then hoverCallback(btn, frame) end
        return frame, btn
    end

    -- Minimize button
    local minimizeFrame, minimizeBtn = createTopBarIcon(assets.minimizeIcon)
    minimizeBtn.MouseButton1Click:Connect(function()
        local state = not WindowFunctions:GetState()
        WindowFunctions:SetState(state)
        WindowFunctions:Notify({
            Title = Settings.Title,
            Description = (state and "Maximized " or "Minimized ") .. "the menu.",
            Lifetime = 5
        })
    end)

    -- Exit button
    local exitFrame, exitBtn = createTopBarIcon(assets.exitIcon)
    ...
    -- Global settings button (globe) – moved to right bar
    local globalFrame, globalBtn = createTopBarIcon(assets.globe)
    globalBtn.MouseButton1Click:Connect(function()
        ...
        if not toggled then
            Tween(globalSettingsUIScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Scale = 1}):Play()
        else
            Tween(globalSettingsUIScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Scale = 0}):Play()
        end
    end)

    -- Add to right bar (order: global, minimize, exit)
    globalFrame.Parent = rightTopbarGroup
    minimizeFrame.Parent = rightTopbarGroup
    exitFrame.Parent = rightTopbarGroup

    rightTopbarGroup.Parent = topbar
    ...
    sidebarGroup.Size = UDim2.new(1, 0, 1, 0)
    ...
    -- UserInfo - fixed to stay inside sidebar at bottom
    ...
    divider5.Position = UDim2.new(0, 0, 1, 0)
    ...
    informationGroup.Position = UDim2.new(0, 0, 0, 0)
    ...
    informationGroupUIPadding.PaddingTop = UDim.new(0, 12)
    ...
    userAndDisplayFrame.Size = UDim2.new(1, -12, 0, 22)
    ...
    content.Position = UDim2.new(0.245, 0, 0, 63)
    content.Size = UDim2.new(0.755, 0, 1, -63)
    ...
    UserInputService.InputChanged:Connect(function(input)
        if resizingContent and input.UserInputType == Enum.UserInputType.MouseMovement then
            ...
            content.Position = UDim2.new(0, newSidebarWidth, 0, 63)
            content.Size = UDim2.new(0, base.AbsoluteSize.X - newSidebarWidth, 1, -63)
        end
    end)
    ...
    -- Global settings panel (unchanged)
    ...
    local function toggleGlobalSettings()
        if not hasGlobalSetting then return end
        toggled = not toggled
        local targetScale = toggled and 1 or 0
        Tween(globalSettingsUIScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Scale = targetScale}):Play()
    end
    globalBtn.MouseButton1Click:Connect(toggleGlobalSettings)
    ...
    function WindowFunctions:GlobalSetting(Settings)
        ...
        local tweens = {
            ...
            nameIn = Tween(settingName, TweenInfo.new(tweensettings.duration, tweensettings.easingStyle), {TextTransparency = tweensettings.transparencyIn}),
            nameOut = Tween(settingName, TweenInfo.new(tweensettings.duration, tweensettings.easingStyle), {TextTransparency = tweensettings.transparencyOut})
        }
        ...
        local function Toggle(State)
            if not State then
                ...
                checkmark:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
                    if checkmark.AbsoluteSize.X <= 0 then checkmark.TextTransparency = 1 end
                end)
            else
                tweens.checkIn:Play()
                tweens.nameIn:Play()
                checkmark:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
                    if checkmark.AbsoluteSize.X > 0 then checkmark.TextTransparency = 0 end
                end)
            end
        end
        ...
        globalSetting.MouseButton1Click:Connect(function()
            toggled = not toggled
            Toggle(toggled)
            task.spawn(function() if Settings.Callback then Settings.Callback(toggled) end end)
        end)

        function GlobalSettingFunctions:UpdateName(NewName) settingName.Text = NewName end
        function GlobalSettingFunctions:UpdateState(NewState) Toggle(NewState); toggled = NewState end
    ...
    function WindowFunctions:TabGroup()
        ...
        function SectionFunctions:Tab(Settings)
            ...
            elements1.Position = UDim2.fromOffset(0, 0)
            elements1.Size = UDim2.new(1, 0, 1, 0)
            ...
            function TabFunctions:Section(Settings)
                ...
                function SectionFunctions:Button(Settings, Flag)
                    ...
                    buttonOutline.Transparency = 0.9
                    ...
                    local function Callback()
                        if ButtonFunctions.Settings.Callback then ButtonFunctions.Settings.Callback() end
                    end
                ...
                function SectionFunctions:Toggle(Settings, Flag)
                    ...
                    local toggleOverlay = Instance.new("TextButton")
                    toggleOverlay.Name = "ToggleOverlay"
                    toggleOverlay.BackgroundTransparency = 1
                    toggleOverlay.BorderSizePixel = 0
                    toggleOverlay.Size = UDim2.new(1, 0, 1, 0)
                    toggleOverlay.AutoButtonColor = false
                    toggleOverlay.ZIndex = 0
                    toggleOverlay.Text = ""
                    toggleOverlay.Parent = toggle
                    toggleOverlay.MouseButton1Click:Connect(Toggle)
                ...
                function SectionFunctions:Slider(Settings, Flag)
                    ...
                    local showValueBox = (Settings.ValueBox == nil or Settings.ValueBox == true)
                    ...
                    if showValueBox then
                        ...
                        headValue = Instance.new("TextLabel")
                        headValue.Name = "headValue"
                        headValue.FontFace = Font.new(assets.interFont)
                        headValue.TextColor3 = Color3.fromRGB(255, 255, 255)
                        headValue.TextSize = 11
                        headValue.TextTransparency = 0.5
                        headValue.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                        headValue.BackgroundTransparency = 1
                        headValue.BorderColor3 = Color3.fromRGB(255, 255, 255)
                        headValue.BorderSizePixel = 0
                        headValue.Size = UDim2.fromOffset(40, 18)
                        headValue.AnchorPoint = Vector2.new(0.5, 1)
                        headValue.Visible = true
                    end
                    ...
                    if not showValueBox and headValue then headValue.Parent = sliderHead; headValue.Position = UDim2.new(0.5, 0, 0, 0) end
                    ...
                    local DisplayMethods = {
                        ...
                        Round = function(sliderValue, precision) return precision and string.format("%." .. precision .. "f", sliderValue) or tostring(math.round(sliderValue)) end,
                        ...
                        Seconds = function(sliderValue, precision) return (precision and string.format("%." .. precision .. "f", sliderValue) or tostring(sliderValue)) .. "s" end
                    }
                    ...
                    local function SetValue(val, ignorecallback)
                        ...
                        local displayText = (Settings.Prefix or "") .. ValueDisplayMethod(finalValue, SliderFunctions.Settings.Precision) .. (Settings.Suffix or "")
                        if showValueBox then if sliderValue then sliderValue.Text = displayText end else if headValue then headValue.Text = displayText; headValue.Visible = true end end
                    ...
                    if showValueBox and sliderValue then
                    ...
                    -- Removed problematic dynamic resize that caused scaling feedback loop
                    ...
                    function SliderFunctions:UpdateValue(Value) SetValue(tonumber(Value), false) end
                ...
                function SectionFunctions:Input(Settings, Flag)
                    ...
                    inputBox.TextTransparency = 0.5  -- greyed like labels
                    ...
                    local function applyCharacterLimit(value) return InputFunctions.Settings.CharacterLimit and value:sub(1, InputFunctions.Settings.CharacterLimit) or value end
                    local CharacterSubs = {
                    ...
                    local AcceptedCharacters = (type(InputFunctions.Settings.AcceptedCharacters) == "function") and InputFunctions.Settings.AcceptedCharacters or CharacterSubs[InputFunctions.Settings.AcceptedCharacters] or CharacterSubs.All
                    InputBox.AutomaticSize = Enum.AutomaticSize.X
                    ...
                    InputBox.FocusLost:Connect(function()
                        ...
                        task.spawn(function() if InputFunctions.Settings.Callback then InputFunctions.Settings.Callback(filteredText) end end)
                    end)
                    ...
                    InputBox:GetPropertyChangedSignal("Text"):Connect(function()
                        ...
                        if InputFunctions.Settings.onChanged then InputFunctions.Settings.onChanged(InputBox.Text) end
                ...
                function SectionFunctions:Keybind(Settings, Flag)
                    ...
                    binderBox.TextTransparency = 0.5  -- greyed
                    ...
                    binderBox.Position = UDim2.new(1, 0, 1, -18)
                        ...
                        if focused and not isBinding then
                            ...
                            Event = UserInputService.InputBegan:Connect(function(input)
                                if KeybindFunctions.Settings.Blacklist and (table.find(KeybindFunctions.Settings.Blacklist, input.KeyCode) or table.find(KeybindFunctions.Settings.Blacklist, input.UserInputType)) then
                                    binderBox:ReleaseFocus(); resetFocusState(); Event:Disconnect()
                                    return
                                end
                                if input.UserInputType == Enum.UserInputType.Keyboard then binded = input.KeyCode; binderBox.Text = input.KeyCode.Name
                                elseif input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.MouseButton2 then binded = input.UserInputType; binderBox.Text = input.UserInputType.Name end
                                if KeybindFunctions.Settings.onBinded then KeybindFunctions.Settings.onBinded(binded) end
                                reset = true; resetFocusState(); Event:Disconnect()
                            end)
                        else
                    ...
                    UserInputService.InputEnded:Connect(function(inp)
                        if not focused and not isBinding then
                            if inp.KeyCode == binded or inp.UserInputType == binded then
                                if Settings.onBindHeld then Settings.onBindHeld(false, binded) end
                            end
                        end
                    end)
                ...
                function SectionFunctions:Dropdown(Settings, Flag)
                    -- (unchanged, keep original functionality)
                    ...
                    local tweensettings = {duration = 0.2, easingStyle = Enum.EasingStyle.Quint, transparencyIn = 0.2, transparencyOut = 0.5, checkSizeIncrease = 12, checkSizeDecrease = -13}
                    local function Toggle(optionName, State)
                        ...
                        if State then
                            if DropdownFunctions.Settings.Multi then
                                ...
                                Selected = {optionName}; DropdownFunctions.Value = Selected[1]
                            end
                        ...
                        if #Selected > 0 then dropdownName.Text = DropdownFunctions.Settings.Name .. " • " .. table.concat(Selected, ", ")
                        else dropdownName.Text = DropdownFunctions.Settings.Name .. "..." end
                    end
                    local dropped = false
                    local db = false
                    local function ToggleDropdown()
                        ...
                        dropTween:Play(); iconTween:Play()
                        if isDropdownOpen then dropdownFrame.Visible = true; dropTween.Completed:Connect(function() db = false end)
                        else dropTween.Completed:Connect(function() dropdownFrame.Visible = false; db = false end) end
                    ...
                    local function addOption(i, v)
                        ...
                        if DropdownFunctions.Settings.Default then
                            if DropdownFunctions.Settings.Multi then isSelected = table.find(DropdownFunctions.Settings.Default, v) and true or false
                            else isSelected = (DropdownFunctions.Settings.Default == i) and true or false end
                        end
                        Toggle(v, isSelected)
                        option.MouseButton1Click:Connect(function()
                            ...
                            task.spawn(function()
                                if DropdownFunctions.Settings.Multi then
                                    local Return = {}; for _, opt in ipairs(Selected) do Return[opt] = true end
                                    if DropdownFunctions.Settings.Callback then DropdownFunctions.Settings.Callback(Return) end
                                else
                                    if newSelected and DropdownFunctions.Settings.Callback then DropdownFunctions.Settings.Callback(Selected[1] or nil) end
                                end
                            end)
                        end)
                    ...
                    function DropdownFunctions:UpdateSelection(newSelection)
                        ...
                        if type(newSelection) == "number" then
                            for option, data in pairs(OptionObjs) do local isSelected = data.Index == newSelection; Toggle(option, isSelected); if isSelected then table.insert(selectedOptions, option) end end
                        elseif type(newSelection) == "string" then
                            for option, data in pairs(OptionObjs) do local isSelected = option == newSelection; Toggle(option, isSelected); if isSelected then table.insert(selectedOptions, option) end end
                        elseif type(newSelection) == "table" then
                            for option, _ in pairs(OptionObjs) do local isSelected = table.find(newSelection, option) ~= nil; Toggle(option, isSelected); if isSelected then table.insert(selectedOptions, option) end end
                        end
                        if DropdownFunctions.Settings.Callback then
                            if DropdownFunctions.Settings.Multi then local Return = {}; for _, opt in ipairs(selectedOptions) do Return[opt] = true end; DropdownFunctions.Settings.Callback(Return)
                            else DropdownFunctions.Settings.Callback(selectedOptions[1] or nil) end
                        end
                    end
                    ...
                    function DropdownFunctions:IsOption(optionName) return OptionObjs[optionName] ~= nil end
                ...
                function SectionFunctions:Colorpicker(Settings, Flag)
                    ...
                    local function updateFromHex()
                        ...
                        r = clampInput(r,0,255); g = clampInput(g,0,255); b = clampInput(b,0,255)
                        modifierInputs.Red.Text = r
                        modifierInputs.Green.Text = g
                        modifierInputs.Blue.Text = b
                        hue, saturation, value = Color3.fromRGB(r,g,b):ToHSV()
                    ...
                    function ColorpickerFunctions:SetColor(color3) ColorpickerFunctions.Color = color3; colorC.BackgroundColor3 = color3; local r = math.floor(ColorpickerFunctions.Color.R * 255 + 0.5); local g = math.floor(ColorpickerFunctions.Color.G * 255 + 0.5); local b = math.floor(ColorpickerFunctions.Color.B * 255 + 0.5); modifierInputs.Red.Text = r; modifierInputs.Green.Text = g; modifierInputs.Blue.Text = b; local hexColor = string.format("#%02X%02X%02X", r,g,b); modifierInputs.Hex.Text = hexColor; hue, saturation, value = Color3.fromRGB(r,g,b):ToHSV(); color1.BackgroundColor3 = ColorpickerFunctions.Color; colour.BackgroundColor3 = Color3.fromRGB(r,g,b); UpdateSlideFromValue(value); UpdateRingFromHSV(hue, saturation); if ColorpickerFunctions.Settings.Callback then task.spawn(function() ColorpickerFunctions.Settings.Callback(ColorpickerFunctions.Color, isAlpha and ColorpickerFunctions.Alpha) end) end end
            ...
            function TabFunctions:InsertConfigSection(Side)
                ...
                local configSelection = configSection:Dropdown({ Name = "Select Config", Multi = false, Required = false, Options = MacLib:RefreshConfigList(), Callback = function(Value) selectedConfig = Value end }, "ConfigSelector")
                configSection:Button({ Name = "Create Config", Callback = function()
                    ...
                    configSelection:ClearOptions(); configSelection:InsertOptions(MacLib:RefreshConfigList())
                end })
                ...
                configSection:Button({ Name = "Refresh Config List", Callback = function()
                    configSelection:ClearOptions(); configSelection:InsertOptions(MacLib:RefreshConfigList())
                end })
                configSection:Button({ Name = "Delete Config", Callback = function()
                    local configDropdown = MacLib.Options["ConfigSelector"]
                    if not configDropdown or not configDropdown.Value then WindowFunctions:Notify({Title = "Delete Config", Description = "No config selected."}); return end
                    local configName = configDropdown.Value
                    local filePath = MacLib.Folder .. "/settings/" .. configName .. ".json"
                    if isfile and isfile(filePath) then delfile(filePath); WindowFunctions:Notify({Title = "Delete Config", Description = string.format("Deleted config %q", configName)}); configDropdown:ClearOptions(); configDropdown:InsertOptions(MacLib:RefreshConfigList())
                    else WindowFunctions:Notify({Title = "Delete Config", Description = "Config file not found."}) end
                end })
                local autoloadLabel
            ...
            function TabFunctions:InsertThemesSection(Side)
                local themesSection = self:Section({ Side = Side or "Left" })
                local themesLabel = themesSection:Label({ Text = "Select Theme" })
                local themeNames = {"Dark", "Light", "Rose", "Mint", "Blue", "Orange"}
                local themeColors = { Dark = Color3.fromRGB(15,15,15), Light = Color3.fromRGB(44,44,44), Rose = Color3.fromRGB(58,42,42), Mint = Color3.fromRGB(42,58,42), Blue = Color3.fromRGB(42,42,58), Orange = Color3.fromRGB(58,46,26) }
                local themeDropdown = themesSection:Dropdown({ Name = "Select Theme", Options = themeNames, Default = 1, Callback = function(selected) local color = themeColors[selected]; if base then base.BackgroundColor3 = color end end })
                local currentThemeLabel = themesSection:Label({ Text = "Current theme: Dark" })
                themeDropdown.Settings.Callback = function(selected) local color = themeColors[selected]; if base then base.BackgroundColor3 = color end; currentThemeLabel:UpdateName("Current theme: " .. selected) end
            end

            -- Renamed from InsertWindowsSection to InsertMenuSection
            function TabFunctions:InsertMenuSection(Side)
                local menuSection = self:Section({ Side = Side or "Left" })
                menuSection:Button({ Name = "Unload GUI", Callback = function() WindowFunctions:Unload() end })
                local currentKeybind = Settings.Keybind or Enum.KeyCode.RightControl
                local keybindElement = menuSection:Keybind({ Name = "Menu Keybind", Default = currentKeybind, Callback = function(bind) WindowFunctions:Notify({Title = "Keybind Changed", Description = "Menu keybind set to " .. bind.Name, Lifetime = 3}) end, onBinded = function(bind) WindowFunctions:SetKeybind(bind) end }, "MenuKeybind")
                local currentScale = baseUIScale.Scale
                local scaleSlider = menuSection:Slider({
                    Name = "UI Scale",
                    ...
                    DisplayMethod = "Value",
                    Precision = 2,
                    Callback = function(value) end, -- no immediate action to avoid feedback
                    onInputComplete = function(value) WindowFunctions:SetScale(value) end  -- apply only after drag
                }, "UIScaleSlider")
            end

            tabs[tabSwitcher] = { tabContent = elements1, tabStroke = tabSwitcherUIStroke, switcherImage = tabImage, switcherName = tabSwitcherName }
            return TabFunctions
        end
        return SectionFunctions
    end
    ...
    function WindowFunctions:Notify(Settings)
        ...
        notification.BackgroundTransparency = acrylicBlur and 0.2 or 0
        ...
        notificationUIStroke.Transparency = acrylicBlur and 0.7 or 0.9
        ...
        notificationIcon.Image = assets.notificationIcon
        notificationIcon.ImageTransparency = 0.1
        ...
        notificationIcon.Size = UDim2.fromOffset(14, 14)
        notificationIcon.Parent = notificationInformation
        local notificationTitle = Instance.new("TextLabel")
        notificationTitle.Name = "NotificationTitle"
        notificationTitle.FontFace = Font.new(assets.interFont, Enum.FontWeight.Medium, Enum.FontStyle.Normal)
        ...
        notificationTitle.Position = UDim2.new(0, 28, 0, 9)
        ...
        notificationDescriptionUIPadding.PaddingBottom = UDim.new(0, -7)
        notificationDescriptionUIPadding.PaddingLeft = UDim.new(0, 10)
        notificationDescriptionUIPadding.PaddingRight = UDim.new(0, 25)
        notificationDescriptionUIPadding.PaddingTop = UDim.new(0, 33)
        ...
        notificationUIPadding.PaddingBottom = UDim.new(0, 18)
        ...
        local tweens = { In = Tween(notificationUIScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Scale = Settings.Scale or 1.1}), Out = Tween(notificationUIScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Scale = 0}) }
    ...
    exitBtn.MouseButton1Click:Connect(function()
        WindowFunctions:Dialog({
            Title = Settings.Title,
            Description = "Are you sure you want to exit the menu? You will lose any unsaved configurations.",
            Buttons = { { Name = "Confirm", Callback = function() WindowFunctions:Unload() end }, { Name = "Cancel" } }
        })
    end)

    function WindowFunctions:SetKeybind(Keycode) MenuKeybind = Keycode end
    function WindowFunctions:GetKeybind() return MenuKeybind end
...
function MacLib:Demo()
    local Window = MacLib:Window({
        ...
        AcrylicBlur = true,
        Logo = "rbxassetid://18821914323",
    })

    local globalSettings = {
        UIBlurToggle = Window:GlobalSetting({ Name = "UI Blur", Default = Window:GetAcrylicBlurState(), Callback = function(bool) Window:SetAcrylicBlurState(bool); Window:Notify({Title = Window.Settings.Title, Description = (bool and "Enabled" or "Disabled") .. " UI Blur", Lifetime = 5}) end }),
        NotificationToggler = Window:GlobalSetting({ Name = "Notifications", Default = Window:GetNotificationsState(), Callback = function(bool) Window:SetNotificationsState(bool); Window:Notify({Title = Window.Settings.Title, Description = (bool and "Enabled" or "Disabled") .. " Notifications", Lifetime = 5}) end }),
        ShowUserInfo = Window:GlobalSetting({ Name = "Show User Info", Default = Window:GetUserInfoState(), Callback = function(bool) Window:SetUserInfoState(bool); Window:Notify({Title = Window.Settings.Title, Description = (bool and "Showing" or "Redacted") .. " User Info", Lifetime = 5}) end })
    }
    ...
    local tabs = {
        ...
        Windows = tabGroups.TabGroup1:Tab({ Name = "Windows", Image = "rbxassetid://10734950309" })
    }
    ...
    tabs.Settings:InsertThemesSection("Right")
    -- Use renamed method
    tabs.Windows:InsertMenuSection("Left")
