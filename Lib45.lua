...
function MacLib:Window(Settings)
	...
	leftGroup.AnchorPoint = Vector2.new(0, 0.5)
	leftGroup.Position = UDim2.fromScale(0, 0.5)
	leftGroup.Size = UDim2.new(0, 400, 1, 0)
	leftGroup.Parent = elements

	local logoBox = Instance.new("Frame")
	logoBox.Name = "LogoBox"
	logoBox.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	logoBox.BackgroundTransparency = 0.98
	logoBox.BorderColor3 = Color3.fromRGB(0, 0, 0)
	logoBox.BorderSizePixel = 0
	logoBox.Size = UDim2.fromOffset(38, 38)
	logoBox.Parent = leftGroup
	...
	logoBoxStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	logoBoxStroke.Color = Color3.fromRGB(255, 255, 255)
	logoBoxStroke.Transparency = 0.9
	logoBoxStroke.Parent = logoBox

	local logoImage = Instance.new("ImageLabel")
	logoImage.Name = "LogoImage"
	logoImage.Image = "rbxassetid://18821914323"
	logoImage.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	logoImage.BackgroundTransparency = 1
	logoImage.Size = UDim2.fromScale(1, 1)
	logoImage.Parent = logoBox

	information.Parent = leftGroup
	information.Position = UDim2.new(0, 45, 0.5, 0) 
	information.AnchorPoint = Vector2.new(0, 0.5)
	information.BackgroundTransparency = 1
	information.Size = UDim2.new(1, -45, 1, 0)
	...
	rightGroup.Position = UDim2.fromScale(1, 0.5)
	rightGroup.Size = UDim2.new(0, 120, 1, 0)
	rightGroup.Parent = elements
	...
	minimizeIcon.Parent = rightGroup
	minimizeIcon.AnchorPoint = Vector2.new(1, 0.5)
	minimizeIcon.Position = UDim2.fromScale(1, -28)
	minimizeIcon.Size = UDim2.fromOffset(16, 16)

	windowControls.Parent = rightGroup
	...
	function WindowFunctions:TabGroup()
		...
		function SectionFunctions:Tab(Settings)
			...
			tabSwitcherUIPadding.PaddingLeft = UDim.new(0, 8)
