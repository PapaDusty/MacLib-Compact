...
function TabFunctions:Section(Settings)
    ...
    collapseBtn.Image = "rbxassetid://6031091078"  -- down arrow
    ...
    titleLabel.FontFace = Font.new(assets.interFont, Enum.FontWeight.Medium, Enum.FontStyle.Normal)
    titleLabel.Text = Settings.Name or "Section"
    ...
    contentPadding.Name = "ContentUIPadding"
    ...
    contentLayout.Name = "ContentUIListLayout"
    ...
    local function setCollapsed(state)
        ...
        collapseBtn.Image = collapsed and "rbxassetid://6031091083" or "rbxassetid://6031091078" -- right / down
    end
    setCollapsed(false)
    ...
    local function showContextMenu()
        ...
        local options = {
            { Name = collapsed and "Expand" or "Collapse", Callback = function() setCollapsed(not collapsed) end },
            { Name = "Move Up", Callback = function()
                local parentFrame = section.Parent
                local sections = {}
                ...
                for i, s in ipairs(sections) do
                    if s == section then idx = i; break end
                end
                if idx and idx > 1 then
                    local order = section.LayoutOrder
                    section.LayoutOrder = sections[idx-1].LayoutOrder
                    sections[idx-1].LayoutOrder = order
                end
            end },
            { Name = "Move Down", Callback = function()
                local parentFrame = section.Parent
                local sections = {}
                for _, child in ipairs(parentFrame:GetChildren()) do
                    if child:IsA("Frame") and child.Name == "Section" then
                ...
                if idx and idx < #sections then
                    local order = section.LayoutOrder
                    section.LayoutOrder = sections[idx+1].LayoutOrder
                    sections[idx+1].LayoutOrder = order
                end
            end },
            { Name = "Reset Section", Callback = function()
                -- Iterate through all elements inside content and try to reset them if they have a Reset method
                ...
                if WindowFunctions.Notify then
                    WindowFunctions:Notify({
                        Title = "Reset",
                        Description = "Section reset to defaults.",
                        Lifetime = 2
                    })
                end
            end },
            { Name = "Remove Section", Callback = function()
                section:Destroy()
            end }
        }
        WindowFunctions:ContextMenu(options, mousePos.X, mousePos.Y)
    end
    ...
    -- ========== ELEMENT CREATION METHODS (all parented to 'content') ==========
    ...
    function SectionFunctions:Button(Settings, Flag)
        ...
        button.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Toggle(Settings, Flag)
        ...
        toggle.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Slider(Settings, Flag)
        ...
        slider.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Input(Settings, Flag)
        ...
        input.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Keybind(Settings, Flag)
        ...
        keybind.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Dropdown(Settings, Flag)
        ...
        dropdown.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Colorpicker(Settings, Flag)
        ...
        colorpicker.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Header(Settings, Flag)
        ...
        header.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Label(Settings, Flag)
        ...
        label.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:SubLabel(Settings, Flag)
        ...
        subLabel.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Paragraph(Settings, Flag)
        ...
        paragraph.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Divider()
        ...
        divider.Parent = content   -- changed from 'section' to 'content'
    ...
    function SectionFunctions:Spacer()
        ...
        spacer.Parent = content   -- changed from 'section' to 'content'
	...
	function WindowFunctions:ContextMenu(options, x, y)
    ...
    menu.Parent = base  -- base is the main window frame
