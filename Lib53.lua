...
function MacLib:Window(Settings)
    ...
    -- GlobalSettingsButton moved to right group, so remove from left
    ...
    rightTopbarGroupUIListLayout.Padding = UDim.new(0, 8)
    ...
    -- Helper function to create a control button with box style like LogoFrame
    local function createControlButton(imageId, name)
        ...
        local function onHover()
            ...
            Tween(frame, TweenInfo.new(0.2, Enum.EasingStyle.Sine), { BackgroundTransparency = 0.95 }):Play()
        end
        local function onLeave()
            Tween(btn, TweenInfo.new(0.2, Enum.EasingStyle.Sine), { ImageTransparency = 0.5 }):Play()
            Tween(frame, TweenInfo.new(0.2, Enum.EasingStyle.Sine), { BackgroundTransparency = 0.98 }):Play()
        end
    ...
    local minimizeFrame, minimizeBtn = createControlButton("131130048783546", "Minimize")
    minimizeBtn.AutoButtonColor = false
    minimizeBtn.Parent = minimizeFrame

    -- Create exit button
    local exitFrame, exitBtn = createControlButton("94126783865996", "Exit")
    exitBtn.AutoButtonColor = false
    exitBtn.Parent = exitFrame

    -- Create global settings button
    local globalSettingsFrame, globalSettingsBtn = createControlButton(assets.globe, "GlobalSettingsButton")
    globalSettingsBtn.AutoButtonColor = false
    globalSettingsBtn.Parent = globalSettingsFrame

    -- Add to right group
    minimizeFrame.Parent = rightTopbarGroup
    exitFrame.Parent = rightTopbarGroup
    globalSettingsFrame.Parent = rightTopbarGroup
    ...
    -- No UIPadding on sidebarGroup to avoid shifting userInfo
    ...
    informationGroup.Position = UDim2.new(0, 30, 0, 2)
    ...
    headshot.Position = UDim2.new(0, 20, 0, 37)
    ...
    -- Content frame with 20% scale (except sidebar and topbar)
    ...
    -- Add UIScale to shrink everything inside content
    local contentUIScale = Instance.new("UIScale")
    contentUIScale.Scale = 0.8
    contentUIScale.Parent = content
    ...
    globalSettingsBtn.MouseButton1Click:Connect(function()
    ...
    function WindowFunctions:TabGroup()
        ...
        function SectionFunctions:Tab(Settings)
            ...
            function TabFunctions:Section(Settings)
                ...
                function SectionFunctions:Slider(Settings, Flag)
                    ...
                    if showValueBox then
                        ...
                        sliderValue.TextTransparency = 0.7  -- Greyer text
                        ...
                        headValue.TextTransparency = 0.7
                    ...
                    sliderBar.Size = UDim2.fromOffset(150, 3)  -- Fixed width to prevent resizing issues
                    ...
                    local DisplayMethods = {
                        ...
                        Seconds = function(sliderValue, precision)
                            local formattedValue2 = precision and string.format("%." .. precision .. "f", sliderValue) or tostring(sliderValue)
                            return formattedValue2 .. "s"
                        end
                    }
                    ...
                    local function SetValue(val, ignorecallback)
                        ...
                        if showValueBox then
                            if sliderValue then
                                sliderValue.Text = displayText
                            end
                        else
                            if headValue then
                                headValue.Text = displayText
                                headValue.Visible = true
                            end
                        end
                ...
                function SectionFunctions:Input(Settings, Flag)
                    ...
                    inputBox.TextTransparency = 0.7  -- Greyer text
                ...
                function SectionFunctions:Keybind(Settings, Flag)
                    ...
                    binderBox.TextTransparency = 0.7  -- Greyer text
                ...
                configSection:Button({
                    ...
                    Callback = function()
                        ...
                        if isfile and isfile(filePath) then
                            ...
                            WindowFunctions:Notify({
                                Title = "Delete Config",
                                Description = string.format("Deleted config %q", configName)
                            })
            ...
            function TabFunctions:InsertThemesSection(Side)
                ...
                local themesLabel = themesSection:Label({
                    Text = "Select Theme",
                })
            ...
            function TabFunctions:InsertMenuSection(Side)  -- Renamed from InsertWindowsSection
                ...
                local keybindElement = menuSection:Keybind({
                    ...
                    Callback = function(bind)
                        -- No notification here; only on bind change
                    end,
    ...
    local function ToggleMenu()
        ...
        -- Removed the notification that repeats the keybind info
    end
...
function MacLib:Demo()
    ...
    local tabs = {
        ...
        Menu = tabGroups.TabGroup1:Tab({ Name = "Menu", Image = "rbxassetid://10734950309" })
    }
    ...
    tabs.Menu:InsertMenuSection("Left")
