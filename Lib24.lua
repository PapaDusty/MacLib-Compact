...
function MacLib:Window(Settings)
	...
	function WindowFunctions:Notify(Settings)
		...
		-- Icon (size 17x17, vertically centered)
		...
		notificationIcon.Size = UDim2.fromOffset(17, 17)
		notificationIcon.Parent = notificationInformation

		-- Title (size 16, vertically centered, anchor point for alignment)
		...
		notificationTitle.Position = UDim2.new(0, 28, 0.5, 0)
		notificationTitle.Parent = notificationInformation

		-- Description (left padding 28 to match title)
		...
		notificationDescriptionUIPadding.PaddingLeft = UDim.new(0, 28)
		notificationDescriptionUIPadding.PaddingRight = UDim.new(0, 25)
		notificationDescriptionUIPadding.PaddingTop = UDim.new(0, 22)
