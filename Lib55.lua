...
function MacLib:Window(Settings)
    ...
    local function createTopBarIcon(imageId, iconSize, hoverCallback)
        ...
        btn.Size = UDim2.fromOffset(iconSize, iconSize)
    ...
    local minimizeFrame, minimizeBtn = createTopBarIcon(assets.minimizeIcon, 18)
    ...
    local exitFrame, exitBtn = createTopBarIcon(assets.exitIcon, 20)
    ...
    local globalFrame, globalBtn = createTopBarIcon(assets.globe, 16)
...
function MacLib:Demo()
    ...
    tabs.Windows:InsertMenuSection("Right")
