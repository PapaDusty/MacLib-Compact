...
function TabFunctions:InsertThemesSection(Side)
    ...
    -- Create the label FIRST so it exists for the callback
    local currentThemeLabel = themesSection:Label({ Text = "Current theme: Dark" })
    -- Set LayoutOrder to 2 so it appears below the dropdown (which will have order 1)
    currentThemeLabel.LayoutOrder = 2

    -- Create the dropdown (LayoutOrder defaults to 1, or we set it explicitly)
