...
function MacLib:Window(Settings)
	...
	function WindowFunctions:Notify(Settings)
		...
		notificationTitle.Position = UDim2.new(0, 36, 0, 10) -- 10 (icon left) + 16 (icon width) + 10 gap = 36
		...
		notificationDescriptionUIPadding.PaddingLeft = UDim.new(0, 5)   -- as requested
		notificationDescriptionUIPadding.PaddingRight = UDim.new(0, 25)
		notificationDescriptionUIPadding.PaddingTop = UDim.new(0, 38)  -- enough space below title row
		...
		notificationUIPadding.PaddingLeft = UDim.new(0, 0)    -- handled by icon/title positions
