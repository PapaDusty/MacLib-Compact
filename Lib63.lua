...
function MacLib:Window(Settings)
    ...
    base.Size = Settings.Size or UDim2.fromOffset(800, 550)
    ...
    leftTopbarGroupUIPadding.PaddingLeft = UDim.new(0, 15)
    ...
    local function createTopBarIcon(imageId, iconSize, hoverCallback)
        ...
        btn.MouseEnter:Connect(function()
            Tween(icon, TweenInfo.new(0.2, Enum.EasingStyle.Sine), {ImageTransparency = 0.2}):Play()
            Tween(stroke, TweenInfo.new(0.2, Enum.EasingStyle.Sine), {Transparency = 0.7}):Play()
        end)
        btn.MouseLeave:Connect(function()
            Tween(icon, TweenInfo.new(0.2, Enum.EasingStyle.Sine), {ImageTransparency = 0.5}):Play()
            Tween(stroke, TweenInfo.new(0.2, Enum.EasingStyle.Sine), {Transparency = 0.9}):Play()
        end)

        if hoverCallback then hoverCallback(btn, icon) end
        return btn, icon
    end

    local minimizeBtn, minimizeIcon = createTopBarIcon(assets.minimizeIcon, 18)
    local minimizeDebounce = false
    minimizeBtn.MouseButton1Click:Connect(function()
        if minimizeDebounce then return end
        minimizeDebounce = true
        task.delay(0.2, function() minimizeDebounce = false end)
    ...
    local exitBtn, exitIcon = createTopBarIcon(assets.exitIcon, 20)
    local exitDebounce = false
    exitBtn.MouseButton1Click:Connect(function()
        if exitDebounce then return end
        exitDebounce = true
        task.delay(0.2, function() exitDebounce = false end)
    ...
    local globalBtn, globalIcon = createTopBarIcon(assets.globe, 16)
    ...
    globalBtn.MouseButton1Click:Connect(function()
        ...
        globalDebounce = true
        task.delay(0.2, function() globalDebounce = false end)
    ...
    globalBtn.Parent = rightTopbarGroup
    minimizeBtn.Parent = rightTopbarGroup
    exitBtn.Parent = rightTopbarGroup
    ...
    sidebarDivider.Size = UDim2.fromOffset(0, 1, 0, 487)
    ...
    dividerInteract.Parent = sidebarDivider
    ...
    sidebarGroup.Size = UDim2.new(1, 0, 1, -107)
    ...
    informationGroup.Position = UDim2.fromOffset(0, 0)
    ...
    local function updateSidebarMinWidth()
        local width = sidebar.AbsoluteSize.X
        if width <= 94 then
            username.Visible = false
            displayName.Visible = false
            informationGroupUIListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
            informationGroupUIPadding.PaddingLeft = UDim.new(0, 0)
            informationGroupUIPadding.PaddingRight = UDim.new(0, 0)
        else
            username.Visible = true
            displayName.Visible = true
            informationGroupUIListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Left
            informationGroupUIPadding.PaddingLeft = UDim.new(0, 15)
            informationGroupUIPadding.PaddingRight = UDim.new(0, 0)
        end
    end

    sidebar:GetPropertyChangedSignal("AbsoluteSize"):Connect(updateSidebarMinWidth)
    ...
    local function ChangeState(State)
        Tween(sidebarDivider, TweenInfo.new(0.2, TweenSettings.EasingStyle), {
    ...
    function WindowFunctions:TabGroup()
        ...
        function SectionFunctions:Tab(Settings)
            ...
            function TabFunctions:Section(Settings)
                ...
                sectionUIPadding.PaddingBottom = UDim.new(0, 12)
                sectionUIPadding.PaddingLeft = UDim.new(0, 15)
                sectionUIPadding.PaddingRight = UDim.new(0, 16)
                sectionUIPadding.PaddingTop = UDim.new(0, 12)
                ...
                if Settings.Name then
                    ...
                    if Settings.Image then
                        ...
                        sectionImage.Image = Settings.Image
                        sectionImage.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                        sectionImage.BackgroundTransparency = 1
                        sectionImage.Size = UDim2.fromOffset(18, 18)
                        sectionImage.ImageTransparency = 0.3
                        sectionImage.Parent = headerFrame
                    end

                    local sectionTitle = Instance.new("TextLabel")
                    sectionTitle.Name = "SectionTitle"
                    sectionTitle.FontFace = Font.new(assets.interFont, Enum.FontWeight.Medium, Enum.FontStyle.Normal)
                    ...
                    local sectionTitleunderline = Instance.new("Frame")
                    sectionTitleunderline.Name = "sectionTitleUnderline"
                    sectionTitleunderline.BackgroundColor3 = Color3.fromRGB(255,255,255)
                    sectionTitleunderline.BackgroundTransparency = 0.5
                    sectionTitleunderline.BorderSizePixel = 0
                    sectionTitleunderline.Size = UDim2.new(1, 0, 0, 1)
                    sectionTitleunderline.Parent = headerFrame
                    sectionTitleunderline.LayoutOrder = 999

                    local sectionDivider = Instance.new("Frame")
                    sectionDivider.Name = "SectionDivider"
                    sectionDivider.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                    sectionDivider.BackgroundTransparency = 0.9
                ...
                function SectionFunctions:Slider(Settings, Flag)
                    ...
                    sliderName.AutomaticSize = Enum.AutomaticSize.None
                    sliderName.Size = UDim2.new(1, -140, 0, 0)
                    sliderName.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                    sliderName.BackgroundTransparency = 1
                    sliderName.BorderColor3 = Color3.fromRGB(0, 0, 0)
                    sliderName.BorderSizePixel = 0
                    sliderName.Position = UDim2.fromScale(0, 0.3)
                    ...
                    if not showValueBox and headValue then
                        headValue.Parent = sliderHead
                        headValue.Position = UDim2.new(0.5, 0, 0, 0)
                    end
                    ...
                    local function SetValue(val, ignorecallback)
                        ...
                        if showValueBox then
                            if sliderValue then sliderValue.Text = displayText end
                        else
                            if headValue then headValue.Text = displayText; headValue.Visible = true end
                        end
                        if not ignorecallback then
                            task.spawn(function() if SliderFunctions.Settings.Callback then SliderFunctions.Settings.Callback(finalValue) end end)
                        end
                ...
                function SectionFunctions:Keybind(Settings, Flag)
                    ...
                    binderBox.TextTransparency = 0.5
                ...
                function SectionFunctions:Dropdown(Settings, Flag)
                    ...
                    local function ToggleDropdown()
                        ...
                        if isDropdownOpen then
                            ...
                            dropTween.Completed:Connect(function() dropdownFrame.Visible = false; db = false end)
                        end
                    ...
                    function DropdownFunctions:UpdateSelection(newSelection)
                        ...
                        if type(newSelection) == "number" then
                            for option, data in pairs(OptionObjs) do
                                ...
                                if isSelected then table.insert(selectedOptions, option) end
                            end
                ...
                function SectionFunctions:Colorpicker(Settings, Flag)
                    ...
                    local baseUICorner2 = Instance.new("UICorner")
                    baseUICorner2.Name = "BaseUICorner"
                    baseUICorner2.CornerRadius = UDim.new(0, 10)
                    baseUICorner2.Parent = cancel
                    ...
                    local wheel1Ref = wheel1
                    local ring = target
                    local sliderVal = value
                    local colour = color
                    ...
                    local function UpdateSlide(iX)
                        local rY = iX - sliderVal.AbsolutePosition.X
                        local cY = math.clamp(rY, 0, sliderVal.AbsoluteSize.X - slide.AbsoluteSize.X)
                        slide.Position = udim2(0, cY, 0.5, 0)
                        value = 1 - (cY / (sliderVal.AbsoluteSize.X - slide.AbsoluteSize.X))
                        update()
                    end
                    local function UpdateRing(iX, iY)
                        local r = wheel1Ref.AbsoluteSize.x / 2
                        local d = v2(iX, iY) - wheel1Ref.AbsolutePosition - wheel1Ref.AbsoluteSize / 2
                        ...
                        sliderVal.BackgroundColor3 = fromHSV(hue, saturation, 1)
                        update()
                    end
                    local function UpdateSlideFromValue(value)
                        local cY = (1 - value) * (sliderVal.AbsoluteSize.X - slide.AbsoluteSize.X)
                    ...
                    wheel1Ref.InputBegan:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then WheelDown = true; UpdateRing(Mouse.X, Mouse.Y) end end)
                    sliderVal.InputBegan:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then SlideDown = true; UpdateSlide(Mouse.X) end end)
                    sliderVal.InputEnded:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then SlideDown = false end end)
                    wheel1Ref.InputEnded:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then WheelDown = false end end)
            ...
            function TabFunctions:InsertConfigSection(Side)
                ...
                configSection:Button({
                    ...
                    Callback = function()
                        ...
                        if not success then
                            WindowFunctions:Notify({Title = "Interface", Description = "Unable to save config, return error: " .. returned})
                        end
                ...
                configSection:Button({
                    ...
                    Callback = function()
                        ...
                        if not success then
                            WindowFunctions:Notify({Title = "Interface", Description = "Unable to load config, return error: " .. returned})
                            return
                        end
                ...
                configSection:Button({
                    ...
                    Callback = function()
                        ...
                        if not success then
                            WindowFunctions:Notify({Title = "Interface", Description = "Unable to overwrite config, return error: " .. returned})
                            return
                        end
                ...
                configSection:Button({
                    ...
                    Callback = function()
                        ...
                        if not configDropdown or not configDropdown.Value then
                            WindowFunctions:Notify({Title = "Delete Config", Description = "No config selected."})
                            return
                        end
                        ...
                        if isfile and isfile(filePath) then
                            delfile(filePath)
                            WindowFunctions:Notify({Title = "Delete Config", Description = string.format("Deleted config %q", configName)})
                            configDropdown:ClearOptions()
                            configDropdown:InsertOptions(MacLib:RefreshConfigList())
                        else
                            WindowFunctions:Notify({Title = "Delete Config", Description = "Config file not found."})
                        end
                    end
                })
                local autoloadLabel
            ...
            function TabFunctions:InsertThemesSection(Side)
                ...
                local themeColors = {
                    ...
                    Light = Color3.fromRGB(44,44,44),
                    Rose = Color3.fromRGB(58,42,42),
                    Mint = Color3.fromRGB(42,58,42),
                    Blue = Color3.fromRGB(42,42,58),
                    Orange = Color3.fromRGB(58,46,26)
                }
                local themeDropdown = themesSection:Dropdown({
                    ...
                    Callback = function(selected)
                        ...
                        if base then base.BackgroundColor3 = color end
                    end
                })
                local currentThemeLabel = themesSection:Label({ Text = "Current theme: Dark" })
                themeDropdown.Settings.Callback = function(selected)
                    local color = themeColors[selected]
                    if base then base.BackgroundColor3 = color end
                    currentThemeLabel:UpdateName("Current theme: " .. selected)
                end
            end
            ...
            function TabFunctions:InsertMenuSection(Side)
                ...
                menuSection:Button({
                    Name = "Unload GUI",
                    Callback = function() WindowFunctions:Unload() end
                })
                local currentKeybind = Settings.Keybind or Enum.KeyCode.RightControl
                local keybindElement = menuSection:Keybind({
                    Name = "Menu Keybind",
                    ...
                    onBinded = function(bind)
                        ...
                        WindowFunctions:Notify({
                            ...
                            Description = "Menu keybind set to " .. bind.Name,
                            Lifetime = 3
                        })
                    end
                }, "MenuKeybind")
                ...
                local scaleSlider = menuSection:Slider({
                    ...
                    onInputComplete = function(value) WindowFunctions:SetScale(value) end
                }, "UIScaleSlider")
            end
    ...
    function WindowFunctions:Notify(Settings)
        ...
        notificationUIStroke.Transparency = 0.95
        ...
        local tweens = {
            In = Tween(notificationUIScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {Scale = Settings.Scale or 1.1}),
    ...
    function WindowFunctions:Dialog(Settings)
        ...
        for _, v in pairs(Settings.Buttons) do
            ...
            local function ChangeState(State)
                if State == "Idle" then
                    Tween(button, TweenInfo.new(0.2, TweenSettings.EasingStyle), {BackgroundTransparency = TweenSettings.DefaultTransparency, TextTransparency = TweenSettings.DefaultTransparency2}):Play()
                elseif State == "Hover" then
                    Tween(button, TweenInfo.new(0.2, TweenSettings.EasingStyle), {BackgroundTransparency = TweenSettings.HoverTransparency, TextTransparency = TweenSettings.HoverTransparency2}):Play()
                end
            end
    ...
    local ClassParser = {
        ["Toggle"] = {
            Save = function(Flag, data)
                return {type = "Toggle", flag = Flag, state = data.State or false}
            end,
        ...
        ["Slider"] = {
            Save = function(Flag, data)
                return {type = "Slider", flag = Flag, value = (data.Value and tostring(data.Value)) or false}
            end,
            Load = function(Flag, data)
